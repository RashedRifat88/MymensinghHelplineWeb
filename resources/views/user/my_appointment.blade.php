...
<body>
    ...
    <div align="center" style="padding:70px;">
        ...
        <table>
            ...
            <tr style="background-color: #34eb7d;">
                <th style="padding:10px; font-size:20px; color: white;">Doctor</th>
                <th style="padding:10px; font-size:20px; color: white;">Date</th>
                <th style="padding:10px; font-size:20px; color: white;">Message</th>
                <th style="padding:10px; font-size:20px; color: white;">Status</th>
                <th style="padding:10px; font-size:20px; color: white;"> Cancel <br>Appointment</th>
            </tr>
            ...
            <tr style="background-color: #cef542;" align="center">
                ...
                <td style="padding:5px; margin:5px;"><a class="btn btn-danger" onclick="return confirm('Are you sure to delete this?')" href="{{url('cancel_appointment', $appointment->id)}}">Cancel</a></td>
